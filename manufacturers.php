...
<li><a href = 'searchManufacturer.php'>Search Manufacturer </a></li>

</div>
<div class = "center2" style="text-align:center" >
<p style = "text-align:center; font-size: 25px">Search for a Manufacturer </p>

<p style = "text-align:center; font-size: 15px"> Input Name to search</p>
<form  method="post" action="searchManufacturer.php"  id="searchform" style = "text-align:center"> 
